...
public class CreateProductRequest {
    ...
    @Schema(description = "Product name", example = "Organic Cotton T-Shirt", requiredMode = Schema.RequiredMode.REQUIRED)
    private String name;
    ...
    @Schema(description = "User ID of the product creator", example = "123e4567-e89b-12d3-a456-426614174000", requiredMode = Schema.RequiredMode.REQUIRED)
    private UUID userId;
    ...
    public CreateProductRequest(String name, String description, BigDecimal price, UUID categoryId, Integer stockQuantity, UUID userId) {
        this.name = name;
